...
function insertarCabeceraobra($descripcion) { 
$sql = "insert into dbcabeceraobra(idcabeceraobra,descripcion) 
...
function modificarCabeceraobra($id,$descripcion) { 
$sql = "update dbcabeceraobra 
set 
descripcion = '".utf8_decode($descripcion)."' 
where idcabeceraobra =".$id; 
$res = $this->query($sql,0); 
return $res; 
} 


function eliminarCabeceraobra($id) { 
$sql = "delete from dbcabeceraobra where idcabeceraobra =".$id; 
$res = $this->query($sql,0); 
return $res; 
} 


function traerCabeceraobra() { 
$sql = "select 
c.idcabeceraobra,
c.descripcion
from dbcabeceraobra c 
order by 1"; 
$res = $this->query($sql,0); 
return $res; 
} 
...
function traerCabeceraobraPorId($id) { 
$sql = "select idcabeceraobra,descripcion from dbcabeceraobra where idcabeceraobra =".$id; 
$res = $this->query($sql,0); 
return $res; 
} 

/* Fin */
/* /* Fin de la Tabla: dbcabeceraobra*/
...
from dbobras o 
inner join tbsalas sal ON sal.idsala = o.refsalas 
inner join tbsedes se ON se.idsede = o.refsedes
left join dbcabeceraobra co ON co.idcabeceraobra = o.refcabeceraobra
order by o.nombre"; 
$res = $this->query($sql,0); 
return $res; 
} 
