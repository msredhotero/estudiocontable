...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Detalle Obras",$_SESSION['refroll_predio'],$_SESSION['sede']);
...
$cadRef2 	= 	$serviciosFunciones->devolverSelectBoxActivo($resSedes,array(1),'',mysql_result($resResultado,0,'refsedes'));

$resOC	=	$serviciosReferencias->traerCabeceraobra();
$cadRef3 	= 	$serviciosFunciones->devolverSelectBoxActivo($resOC,array(1),'',mysql_result($resResultado,0,'refcabeceraobra'));
