...
break; 
case 'insertarCabeceraobra': 
insertarCabeceraobra($serviciosReferencias); 
break; 
case 'modificarCabeceraobra': 
modificarCabeceraobra($serviciosReferencias); 
break; 
case 'eliminarCabeceraobra': 
eliminarCabeceraobra($serviciosReferencias); 
break; 
...
function insertarCabeceraobra($serviciosReferencias) { 
$descripcion = $_POST['descripcion']; 
$res = $serviciosReferencias->insertarCabeceraobra($descripcion); 
if ((integer)$res > 0) { 
echo ''; 
} else { 
...
function modificarCabeceraobra($serviciosReferencias) { 
$id = $_POST['id']; 
$descripcion = $_POST['descripcion']; 
$res = $serviciosReferencias->modificarCabeceraobra($id,$descripcion); 
if ($res == true) { 
echo ''; 
} else { 
...
function eliminarCabeceraobra($serviciosReferencias) { 
$id = $_POST['id']; 
$res = $serviciosReferencias->eliminarCabeceraobra($id); 
echo $res; 
} 
